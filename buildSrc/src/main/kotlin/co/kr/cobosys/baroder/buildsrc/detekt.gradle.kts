...
detekt {
    toolVersion = co.kr.cobosys.baroder.buildsrc.Depends.Versions.detektVersion
...
dependencies {
    detektPlugins(co.kr.cobosys.baroder.buildsrc.Depends.ClassPaths.detekt_gradle_plugin)
}
